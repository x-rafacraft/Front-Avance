...
@Component({
  selector: 'app-de-paciente-modificacion',
  standalone: true,
  imports: [
    CommonModule,
    RouterModule
  ],
  templateUrl: './de-paciente-modificacion.component.html',
  styleUrl: './de-paciente-modificacion.component.css'
})
export default class DePacienteModificacionComponent implements OnInit {
  paciente: Paciente = {
    id: 0,
