...
@Component({
  selector: 'app-de-cita-creacion',
  standalone: true,
  imports: [
    CommonModule,
    RouterModule
  ],
  templateUrl: './de-cita-creacion.component.html',
  styleUrl: './de-cita-creacion.component.css'
})
export default class DeCitaCreacionComponent implements OnInit {
  theuser: Usuario = {
    Nombre: '',
    Apellido: '',
    Celular: '',
