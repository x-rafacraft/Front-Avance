...
@Component({
  selector: 'app-de-cita-modificacion',
  standalone: true,
  imports: [
    CommonModule,
    RouterModule
  ],
  templateUrl: './de-cita-modificacion.component.html',
  styleUrl: './de-cita-modificacion.component.css'
})
export default class DeCitaModificacionComponent implements OnInit {
  theuser: Usuario = {
    Nombre: '',
    Apellido: '',
    Celular: '',
