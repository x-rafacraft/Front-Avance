...
@Component({
  selector: 'app-de-cita-listado',
  standalone: true,
  imports: [
    CommonModule,
    RouterModule
  ],
  templateUrl: './de-cita-listado.component.html',
  styleUrl: './de-cita-listado.component.css'
})
export default class DeCitaListadoComponent implements OnInit {
  theuser: Usuario = {
    Nombre: '',
    Apellido: '',
    Celular: '',
