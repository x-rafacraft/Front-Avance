...
@Component({
  selector: 'app-dd-paciente-listado',
  standalone: true,
  imports: [
    CommonModule,
    RouterModule
  ],
  templateUrl: './dd-paciente-listado.component.html',
  styleUrl: './dd-paciente-listado.component.css'
})
export default class DdPacienteListadoComponent implements OnInit {
  theuser: Usuario = {
    Nombre: '',
    Apellido: '',
    Celular: '',
