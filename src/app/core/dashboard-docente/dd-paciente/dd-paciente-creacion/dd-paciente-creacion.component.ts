...
@Component({
  selector: 'app-dd-paciente-creacion',
  standalone: true,
  imports: [
    CommonModule,
    RouterModule
  ],
  templateUrl: './dd-paciente-creacion.component.html',
  styleUrl: './dd-paciente-creacion.component.css'
})
export default class DdPacienteCreacionComponent implements OnInit {
  theuser: Usuario = {
    Nombre: '',
    Apellido: '',
    Celular: '',
