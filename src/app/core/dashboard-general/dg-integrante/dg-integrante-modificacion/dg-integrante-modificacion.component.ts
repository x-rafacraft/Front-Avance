...
@Component({
  selector: 'app-dg-integrante-modificacion',
  standalone: true,
  imports: [
    CommonModule,
    RouterModule
  ],
  templateUrl: './dg-integrante-modificacion.component.html',
  styleUrl: './dg-integrante-modificacion.component.css'
})
export default class DgIntegranteModificacionComponent implements OnInit {
  usuario: Usuario = {
    Nombre: '',
    Apellido: '',
    Celular: '',
