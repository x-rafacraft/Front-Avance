...
@Component({
  selector: 'app-dg-integrante-creacion',
  standalone: true,
  imports: [
    CommonModule,
    RouterModule
  ],
  templateUrl: './dg-integrante-creacion.component.html',
  styleUrl: './dg-integrante-creacion.component.css'
})
export default class DgIntegranteCreacionComponent implements OnInit {
  usuario: Usuario = {
    Nombre: '',
    Apellido: '',
    Celular: '',
  ...
  onsedeSelected(event: any) {
    ...
    console.log(this.usuario.SedeId);
